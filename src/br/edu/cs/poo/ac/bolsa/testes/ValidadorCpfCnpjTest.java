...
public class ValidadorCpfCnpjTest {
    ...
    public void testCpfNaoInformado() {
        assertEquals(
            ResultadoValidacao.NAO_INFORMADO,
    ...
    public void testCpfFormatoInvalido() {
        assertEquals(
            ResultadoValidacao.FORMATO_INVALIDO,
            ValidadorCpfCnpj.validarCpf("123")
        ); // muito curto

        assertEquals(
            ResultadoValidacao.FORMATO_INVALIDO,
            ValidadorCpfCnpj.validarCpf("111.111.111-11")
        ); // repetido
    }
    ...
    public void testCpfDvInvalido() {
        assertEquals(
            ResultadoValidacao.DV_INVALIDO,
            ValidadorCpfCnpj.validarCpf("12345678908")
        ); // DV errado
    }
    ...
    public void testCnpjFormatoInvalido() {
        assertEquals(
            ResultadoValidacao.FORMATO_INVALIDO,
            ValidadorCpfCnpj.validarCnpj("123")
        ); // muito curto

        assertEquals(
            ResultadoValidacao.FORMATO_INVALIDO,
            ValidadorCpfCnpj.validarCnpj("11.111.111/1111-11")
        ); // repetido
    }
