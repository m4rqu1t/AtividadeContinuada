...
public class InvestidorMediatorTest extends TesteGenerico {
    ...
    void incluirEmpresaJaExistente() {
        ...
        assertTrue(
            msgs.getMensagens()[0].equals("Investidor Empresa já existente.")
        );
    }
    ...
    void alterarEmpresaNaoExistente() {
        ...
        assertFalse(msgs.estaVazio());
        assertTrue(
            msgs.getMensagens()[0].equals("Investidor Empresa não existente.")
        );
    }
    ...
    void excluirEmpresaComSucesso() {
        ...
        MensagensValidacao msgs = mediator.excluirInvestidorEmpresa(
            "51121160000120"
        );
    ...
    void incluirPessoaJaExistente() {
        ...
        assertFalse(msgs.estaVazio());
        assertTrue(
            msgs.getMensagens()[0].equals("Investidor Pessoa já existente.")
        );
    }
    ...
    void alterarPessoaNaoExistente() {
        ...
        assertFalse(msgs.estaVazio());
        assertTrue(
            msgs.getMensagens()[0].equals("Investidor Pessoa não existente.")
        );
    }
    ...
    void excluirPessoaComSucesso() {
        ...
        MensagensValidacao msgs = mediator.excluirInvestidorPessoa(
            "80052380610"
        );
    ...
    void contatosTelefoneComLetras() {
        ...
        assertTrue(
            msgs
                .getMensagens()[0].equals(
                    "Telefone celular deve conter apenas números."
                )
        );
    }
