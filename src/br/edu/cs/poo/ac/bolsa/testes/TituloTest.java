...
public class TituloTest {
    ...
    void deveAplicarFormulaCorretamenteParaDiasEspecificos() {
        ...
        BigDecimal esperado = new BigDecimal("1000").multiply(
            new BigDecimal("1.01").pow(3)
        );
    ...
    void testGetNumeroParaInvestidorPessoa() {
        ...
        String esperado =
            "000" + pessoa.getCpf() + ativo.getCodigo() + "202403100000";
    ...
    void testGetNumeroParaInvestidorEmpresa() {
        // Mocks simples
        InvestidorEmpresa empresa = new InvestidorEmpresa(
            "ACME",
            null,
            null,
            BigDecimal.ZERO,
        ...
        String esperado =
            empresa.getCnpj() + ativo.getCodigo() + "202405200000";
